...
public class StockOutDetailController {
     ...
     */
    @GetMapping
    public Pager<StockOutDetail> getPage(Pager<StockOutDetail> pager, StockOutDetail stockOutDetail) {
        IPage<StockOutDetail> page = stockOutDetailService.page(pager.toPage(), new QueryWrapper<>(stockOutDetail));
